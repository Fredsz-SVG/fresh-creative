...
const BASE_CLASS =
  'w-full border-2 border-slate-200 dark:border-slate-700 rounded-2xl md:rounded-3xl shadow-[2px_2px_0_0_#334155] dark:shadow-[2px_2px_0_0_#1e293b] md:shadow-[2px_2px_0_0_#334155] dark:md:shadow-[2px_2px_0_0_#334155] px-4 py-3 md:px-6 md:py-4 font-black text-xs md:text-sm animate-bounce-subtle'
