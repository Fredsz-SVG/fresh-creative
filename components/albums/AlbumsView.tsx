...
function AlbumCard({
  ...
  if (isClickable && !isLoading) {
    return (
      <Link href={destinationUrl} legacyBehavior>
        <a><CardContent /></a>
      </Link>
    )
  }
    ...
    <div>
      ...
      <div className="flex flex-col gap-4 mb-5 md:mb-6 md:flex-row md:justify-between md:items-center">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:gap-2">
          <Link href={publicCreateHref} legacyBehavior>
            <a className="w-full sm:w-auto text-center px-4 py-3 sm:py-2 bg-sky-600 text-white text-sm font-semibold rounded-xl hover:bg-sky-700 active:bg-sky-800 touch-manipulation">+ Buat Public Album</a>
          </Link>
          <Link href={showroomHref} legacyBehavior>
            <a className="w-full sm:w-auto text-center px-4 py-3 sm:py-2 bg-purple-600 text-white text-sm font-semibold rounded-xl hover:bg-purple-700 active:bg-purple-800 touch-manipulation">+ Order Yearbook</a>
          </Link>
        </div>
      </div>
