...
export function DemoLivePhoto() {
  return (
    <section id="demo-livephoto" className="min-h-dvh w-full bg-black text-blue-50">
      <div className="flex size-full flex-col items-center py-10 pb-24">
        ...
        <div className="mx-auto mt-8 grid max-w-4xl grid-cols-1 gap-6 px-4 sm:grid-cols-3 md:mt-10 md:gap-8">
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            <span className="font-zentry mb-2 flex h-10 w-10 items-center justify-center rounded-full border-2 border-blue-50/50 bg-blue-50/5 text-xl font-black text-blue-50">
              1
            </span>
            <h3 className="font-general text-sm font-bold uppercase tracking-wide text-blue-50">
              Scan QR Code
            </h3>
            <p className="mt-1.5 text-sm leading-relaxed text-blue-50/80">
        ...
        <div className="relative z-20 mt-2 flex w-full justify-center px-4 pb-12 md:-mt-4 md:justify-center md:px-0 md:pb-16">
          <div className="flex w-full max-w-5xl flex-col items-center md:items-center">
            <p className="font-general mt-3 w-full max-w-4xl text-center text-sm leading-relaxed text-violet-50 md:text-base">
