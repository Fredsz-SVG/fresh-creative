          ...
          <div className="px-8 sm:px-20">
            ...
            <a href="#pricing">
              <Button
                ...
                containerClass="bg-yellow-300 flex-center gap-1 border border-slate-900 rounded-full shadow-[2px_2px_0_0_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[2px_2px_0_0_#000] transition-all active:translate-x-0 active:translate-y-0 active:shadow-none font-black text-sm sm:text-base"
              >
                Buat Project
              </Button>
            </a>
