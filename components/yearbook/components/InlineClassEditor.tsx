...
export default function InlineClassEditor(p: InlineClassEditorProps) {
  ...
  return (
    <div className={`w-full ${p.center ? 'flex justify-center' : ''}`}>
      {!editing ? (
        <div className={`w-full p-4 bg-white dark:bg-slate-900 border-2 border-slate-900 dark:border-slate-700 rounded-2xl shadow-[1.5px_1.5px_0_0_#334155] dark:shadow-[1.5px_1.5px_0_0_#1e293b] ${p.center ? 'flex justify-center' : ''}`}>
            ...
            {isOwner && (
              <div className="flex gap-2 flex-shrink-0">
                ...
                <button
                  ...
                  className={`${p.mainHeader ? 'w-10 h-10 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl' : 'w-8 h-8 lg:w-9 lg:h-9 rounded-xl'} flex items-center justify-center bg-white dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 text-red-500 hover:bg-red-50 dark:hover:bg-red-950/50 hover:shadow-[1.5px_1.5px_0_0_#334155] dark:hover:shadow-[2px_2px_0_0_#334155] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all`}
                  title="Hapus kelas"
                >
        ...
        <div className="flex flex-col gap-4 w-full bg-amber-50 dark:bg-amber-950/30 p-4 rounded-[24px] border-2 border-slate-900 dark:border-slate-700 shadow-[1.5px_1.5px_0_0_#334155] dark:shadow-[1.5px_1.5px_0_0_#1e293b] animate-in zoom-in-95 duration-200">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-indigo-500 text-white border-2 border-slate-900 dark:border-slate-700 font-black text-[10px] uppercase tracking-widest shadow-[1.5px_1.5px_0_0_#334155] dark:shadow-[1.5px_1.5px_0_0_#1e293b] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all"
            >
              Simpan
            </button>
            <button
