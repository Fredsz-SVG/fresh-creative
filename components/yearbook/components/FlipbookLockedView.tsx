...
export default function FlipbookLockedView({ albumId, isOwner, creditCost, onUnlocked }: FlipbookLockedViewProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center bg-white dark:bg-slate-900 rounded-[40px] border-4 border-slate-900 dark:border-slate-700 shadow-[12px_12px_0_0_#0f172a] dark:shadow-[12px_12px_0_0_#334155] max-w-lg mx-auto my-12">
      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-[32px] bg-amber-400 dark:bg-amber-500 flex items-center justify-center mb-8 border-4 border-slate-900 dark:border-slate-600 shadow-[8px_8px_0_0_#0f172a] dark:shadow-[8px_8px_0_0_#334155]">
        <div className="relative">
          <Book className="w-10 h-10 sm:w-12 sm:h-12 text-slate-900" strokeWidth={3} />
          <div className="absolute -bottom-2 -right-2 bg-white dark:bg-slate-800 rounded-lg border-2 border-slate-900 dark:border-slate-600 p-1 shadow-[2px_2px_0_0_#0f172a] dark:shadow-[2px_2px_0_0_#334155]">
      ...
      {isOwner && (
        <div className="flex flex-col items-center gap-6 w-full">
          <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-50 dark:bg-slate-800 border-4 border-slate-900 dark:border-slate-600 shadow-[4px_4px_0_0_#0f172a] dark:shadow-[4px_4px_0_0_#334155]">
