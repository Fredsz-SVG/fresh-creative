...
export default function FlipbookLockedView({ albumId, isOwner, creditCost, onUnlocked }: FlipbookLockedViewProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center bg-white dark:bg-slate-900 rounded-[40px] border-2 border-slate-900 dark:border-slate-700 max-w-lg mx-auto my-12">
      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-[32px] bg-amber-400 dark:bg-amber-500 flex items-center justify-center mb-8 border-2 border-slate-900 dark:border-slate-700">
        <div className="relative">
          <Book className="w-10 h-10 sm:w-12 sm:h-12 text-slate-900" strokeWidth={3} />
          <div className="absolute -bottom-2 -right-2 bg-white dark:bg-slate-800 rounded-lg border-2 border-slate-900 dark:border-slate-700 p-1">
      ...
      {isOwner && (
        <div className="flex flex-col items-center gap-6 w-full">
          <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-50 dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700">
      ...
      {confirmOpen && (
        <div className="fixed inset-0 bg-slate-900/40 dark:bg-black/50 backdrop-blur-md flex items-center justify-center z-[200] p-4">
          <div className="bg-white dark:bg-slate-900 border-2 border-slate-900 dark:border-slate-700 rounded-[32px] p-6 sm:p-8 max-w-sm w-full text-center">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3.5 rounded-xl bg-slate-100 dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-black uppercase tracking-widest hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
              >
                Batal
              </button>
              <button
                ...
                className="flex-1 py-3.5 rounded-xl bg-amber-400 dark:bg-amber-600 text-slate-900 dark:text-white border-2 border-slate-900 dark:border-slate-700 text-xs font-black uppercase tracking-widest hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
              >
                Ya, Buka
              </button>
            </div>
