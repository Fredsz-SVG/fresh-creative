    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-140px)] lg:h-[calc(100vh-80px)] gap-4 lg:gap-6 w-full max-w-7xl mx-auto px-4 py-4 lg:py-6 overflow-x-hidden">
            ...
            <div className={`${mobileTab === 'pages' || manualPages.length === 0 ? 'flex' : 'hidden'} lg:flex flex-col w-full lg:w-72 gap-4 lg:gap-6 flex-shrink-0 order-3 lg:order-1 lg:h-full`}>
                {canManage && (
                    <div className="order-0 w-full bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-900 dark:border-slate-700 p-4 shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b]">
                        ...
                        <div className="flex gap-2 mb-3">
                            <div className="flex-1">
                                ...
                                >
                                    <div className="w-8 h-8 rounded-lg bg-emerald-400 dark:bg-emerald-600 border-2 border-slate-900 dark:border-slate-700 flex items-center justify-center group-hover:rotate-3 transition-transform shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] flex-shrink-0">
                            ...
                            <div className="flex-1">
                                ...
                                >
                                    <div className="w-8 h-8 rounded-lg bg-orange-400 dark:bg-orange-600 border-2 border-slate-900 dark:border-slate-700 flex items-center justify-center group-hover:rotate-3 transition-transform shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] flex-shrink-0">
                        ...
                        <div className="mb-0">
                            ...
                            >
                                <div className="w-10 h-10 rounded-xl bg-indigo-400 dark:bg-indigo-600 border-2 border-slate-900 dark:border-slate-700 flex items-center justify-center group-hover:rotate-3 transition-transform shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] flex-shrink-0">
                ...
                <div className="w-full bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-900 dark:border-slate-700 p-4 shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] h-auto lg:flex-1 flex flex-col min-h-0">
                        ...
                        {manualPages.map((page, index) => {
                            ...
                            <div
                                ...
                                className={`flex-shrink-0 w-20 sm:w-24 lg:w-full flex flex-col lg:flex-row gap-1.5 lg:gap-3 p-1.5 lg:p-2 rounded-xl border-2 lg:border-4 transition-all text-left group snap-start lg:snap-align-none ${selectedManualPageId === page.id
                                    ? 'bg-amber-400 dark:bg-amber-500 border-slate-900 dark:border-slate-700 shadow-[4px_4px_0_0_#334155] lg:shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] lg:dark:shadow-[4px_4px_0_0_#1e293b] -translate-y-0.5 lg:-translate-y-0'
                            ...
                            >
                                ...
                                >
                                    <div className="w-full lg:w-14 aspect-[3/4] lg:h-[76px] bg-slate-100 dark:bg-slate-800 rounded-md overflow-hidden flex-shrink-0 border-2 border-slate-900 dark:border-slate-700 relative lg:group-hover:shadow-[4px_4px_0_0_#334155] dark:group-hover:shadow-[2px_2px_0_0_#334155] transition-all">
            ...
            <div className={`${mobileTab === 'hotspots' ? 'flex' : 'hidden'} lg:flex w-full lg:w-72 flex-col gap-4 flex-shrink-0 bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-900 dark:border-slate-700 p-4 order-4 lg:order-3 h-auto lg:h-full shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b]`}>
                ...
                {selectedPage?.flipbook_video_hotspots && selectedPage.flipbook_video_hotspots.length > 0 ? (
                    <div className="flex-1 overflow-y-auto min-h-0 no-scrollbar pr-1 space-y-4">
                        {selectedPage.flipbook_video_hotspots.map((h, i) => {
                            return (
                            <div key={h.id} className={`p-4 bg-white dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 rounded-2xl space-y-4 shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] ${!canManage ? 'opacity-80' : ''}`}>
                                ...
                                {!canManage && h.video_url && (
                                    <button
                                        ...
                                        className="w-full py-2 bg-indigo-400 dark:bg-indigo-600 text-white border-2 border-slate-900 dark:border-slate-700 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] hover:shadow-none hover:translate-x-1 hover:translate-y-1 active:translate-x-1.5 active:translate-y-1.5 transition-all"
                                    >
                                        Play Video
                                    </button>
                                )}
            ...
            <div className={`w-full min-h-[55vh] lg:flex-1 lg:min-h-0 shrink-0 bg-white dark:bg-slate-900 rounded-[28px] lg:rounded-[36px] border-2 border-slate-900 dark:border-slate-700 overflow-hidden relative flex flex-col order-1 lg:order-2 shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] ${manualPages.length === 0 ? 'hidden lg:flex' : ''}`}>
                <div className="flex-1 relative overflow-auto p-4 sm:p-12 flex no-scrollbar bg-white dark:bg-slate-900 min-h-[300px]">
                    {selectedPage ? (
                        <div
                            className={`relative m-auto rounded-sm overflow-hidden shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] border-2 lg:border-2 border-slate-900 dark:border-slate-700 group ${isPageReady ? 'transition-opacity duration-700 opacity-100' : 'opacity-0'}`}
            ...
            {deleteHotspotConfirm && (
                <div className="fixed inset-0 bg-slate-900/40 dark:bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
                    <div className="bg-white dark:bg-slate-900 border-2 border-slate-900 dark:border-slate-700 rounded-[32px] p-8 max-w-md w-full shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] animate-in zoom-in-95 duration-200">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 py-4 px-6 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-2 border-slate-900 dark:border-slate-700 font-black rounded-2xl uppercase tracking-widest text-xs shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:translate-x-0.5 active:translate-y-0.5"
                            >
                                Batal
                            </button>
                            <button
                                ...
                                className="flex-1 py-4 px-6 bg-red-500 text-white border-2 border-slate-900 dark:border-slate-700 font-black rounded-2xl uppercase tracking-widest text-xs shadow-[4px_4px_0_0_#334155] dark:shadow-[4px_4px_0_0_#1e293b] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
                            >
                                Ya, Hapus
                            </button>
                        </div>
