...
export default function ClassesEmptyView({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[50vh] px-4 py-8">
      <div className="flex flex-col items-center justify-center text-center max-w-md w-full rounded-2xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 px-8 py-14 shadow-[2px_2px_0_0_rgba(15,23,42,0.18)] dark:shadow-[2px_2px_0_0_rgba(51,65,85,0.55)]">
              ...
              <div className="w-full max-w-xs flex flex-col gap-2 text-left">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={onAddClass}
                    className="flex-1 px-4 py-2 rounded-xl bg-indigo-500 text-white text-sm font-black hover:bg-indigo-600 active:translate-x-0.5 active:translate-y-0.5 transition-all border-2 border-slate-200 dark:border-slate-600 shadow-[2px_2px_0_0_rgba(15,23,42,0.18)] dark:shadow-[2px_2px_0_0_rgba(51,65,85,0.55)]"
                  >
                    Tambah
                  </button>
                  <button
