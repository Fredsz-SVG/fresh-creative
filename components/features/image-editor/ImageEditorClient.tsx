...
import type { BgRemovalMode, EditorTab, Filters, HistoryEntry, Transform, IconOverlay } from './types'
import { getEmojiForType, getGradientColors, getSliderMax } from './utils'
...
export default function ImageEditor() {
  ...
  const [bgRemovalMode, setBgRemovalMode] = useState<BgRemovalMode>('remove')
