                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1.5">
                                    ...
                                    <span className="text-xs font-black text-indigo-600 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 px-2 py-0.5 rounded-md border-2 border-slate-200 dark:border-slate-600">{currentCredit} CREDITS</span>
                                </div>
                            </div>
                        </div>
                        <button
                                    ...
                                    <div className="grid grid-cols-2 gap-3 pt-4 pb-3">
                                        {packages.map((pkg) => (
                                            ...
                                            >
                                                ...
                                                <div className={`mt-3 text-[10px] font-black px-2 py-1.5 w-full rounded-lg border-2 border-slate-200 dark:border-slate-600 ${selectedPkg === pkg.id ? 'bg-white dark:bg-slate-800 text-slate-900 dark:text-white' : 'bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-300'}`}>
