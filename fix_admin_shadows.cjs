...
let contentStr = fsStr.readFileSync('app/admin/page.tsx', 'utf8');
...
contentStr = contentStr.replace(/shadow-\[4px_4px_0_0_#0f172a\]/g, 'shadow-[3px_3px_0_0_#64748b]');
contentStr = contentStr.replace(/hover:shadow-\[5px_5px_0_0_#0f172a\]/g, 'hover:shadow-[4px_4px_0_0_#64748b]');


fsStr.writeFileSync('app/admin/page.tsx', contentStr);
